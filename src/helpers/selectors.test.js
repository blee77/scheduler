...
//   const result = getInterviewersForDay(state, "Monday");
//   expect(result.length).toEqual(0); // Modify this value to match the expected number of interviewers for Monday
// });
...
//   expect(result).toEqual([state.interviewers["2"]]); // Modify this value to match the expected interviewer objects for Tuesday
// });
  ...
  days: [
    {
      ...
      name: "Monday",
      appointments: [1, 2, 3],
      interviewers: [] // Update the interviewers array for Monday to be empty
    },
    {
      id: 2,
      name: "Tuesday",
      appointments: [4, 5],
      interviewers: [2] // Update the interviewers array for Tuesday
    }
  ],
